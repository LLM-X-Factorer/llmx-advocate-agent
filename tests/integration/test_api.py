...
@pytest.mark.asyncio
async def test_create_task_runs_through_p2_then_pauses(client):
    """P1 + P1.5 + P2 all implemented; pauses at P2.5 (stub)."""
    ...
    assert body["task"]["current_phase"] == "P2.5"
    ...
    assert by_phase["P2.5"]["status"] == "error"
