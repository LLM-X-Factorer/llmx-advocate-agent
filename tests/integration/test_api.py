...
@pytest.mark.asyncio
async def test_create_task_runs_through_p2_5_then_pauses(client):
    """P1 + P1.5 + P2 + P2.5 all implemented; pauses at P2.6 (stub)."""
    ...
    assert body["task"]["current_phase"] == "P2.6"
    ...
    assert by_phase["P2.6"]["status"] == "error"
